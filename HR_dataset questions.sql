-- questions
-- 1. what  is the gender breakdown of employees in the companyt?
...
-- also how gender is distributed across age groups
...
-- 4. How many employees works at headquarter vs remote
...
-- 10. How has the company's employee count changed over time on hire and term dates?
select
	year,
    hires,
    terminations,
